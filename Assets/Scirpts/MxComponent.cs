...
public class MxComponent : MonoBehaviour
{
    ...
    const string X_START_PLC2UNITY = "X10"; // PLC의 버튼 정보를 Unity로 보내는 시작 X디바이스 포인트 주소
    const string Y_START_PLC2UNITY = "Y0"; // Unity의 버튼 정보를 PLC로 보내는 시작 Y디바이스 포인트 주소
    const int X_BLOCKCNT_UNITY2PLC = 1;     // Unity의 버튼 정보를 PLC로 보내는 X디바이스 블록 개수
    const int X_BLOCKCNT_PLC2UNITY = 1;     // PLC의 버튼 정보를 Unity로 보내는 X디바이스 블록 개수
    const int Y_BLOCKCNT_PLC2UNITY = 1;     // PLC의 버튼 정보를 Unity로 보내는 Y디바이스 블록 개수
